  ...
  return (
    <PageTemplete>
      ...
      <div className='container max-w-7xl py-16'>
        <h4 className='my-5 border-l-8 border-indigo-600 p-3 text-2xl font-bold'>個人情報とは</h4>
        ...
        <h4 className='my-5 border-l-8 border-indigo-600 p-3 text-2xl font-bold'>
          個人情報の収集・利用目的
        </h4>
        <p className='my-3 text-gray-500'>
          当社では、お客様のご住所、お名前、ご注文商品、電話番号、メールアドレスなどの情報は、サービスのご案内や調査（アンケート）などに使用させていただく場合がありますので、あらかじめご了承ください。
        </p>
        <h4 className='my-5 border-l-8 border-indigo-600 p-3 text-2xl font-bold'>個人情報の開示</h4>
        <p className='my-3 text-gray-500'>
        ...
        <h4 className='my-5 border-l-8 border-indigo-600 p-3 text-2xl font-bold'>注意事項</h4>
        <p className='my-3 text-gray-500'>
