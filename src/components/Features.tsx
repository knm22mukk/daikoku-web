...
export const Features: FC = () => {
  return (
    <section className='py-16 container max-w-7xl'>
      <div className='flex items-center flex-col px-4'>
        <p className='uppercase text-sm text-center text-indigo-500 leading-4'>
      ...
      <div aria-label='group of cards' className='mt-20 flex flex-wrap justify-center gap-10 px-4'>
        {FeatureItems.map((feature, index) => (
          <div key={index} className='flex sm:w-full md:w-5/12 pb-20'>
            ...
            <div className='w-10/12'>
              ...
              <p className='text-base text-gray-600 leading-normal pt-2'>{feature.description}</p>
            </div>
          </div>
        ))}
      </div>
